...
NB_HISTORIC_DATA_HOURS_TO_PRELOAD_FOR_TRADING = 24
...
#     => The limit order mode (between B1 and B2 threshold) has not been fully tested. So I recommend to only use market orders.
...
#     => The limit order mode (between S1 and S2 threshold) has not been fully tested. So I recommend to only use market orders.
